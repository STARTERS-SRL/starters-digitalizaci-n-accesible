  ...
  return (
    <section id="servicios" className="relative py-32 px-6 lg:px-10">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-3 lg:grid-rows-2 gap-5 auto-rows-fr">
          {services.map((s, i) => {
            const Icon = s.icon;
            return (
              <Reveal key={s.title} delay={i * 120} className={s.span}>
                <div className="group relative h-full glass rounded-2xl p-8 overflow-hidden transition-all duration-500 hover:border-accent/40 hover:-translate-y-1">
